...
def analyze_student_solution(exam_text: str, student_text: str, api_key: str) -> dict:
    """
    Compare student's solution with the exam solution using Gemini.
    Uses a dynamic API key from request.
    """
    client = genai.Client(api_key=api_key)  # create client per request
